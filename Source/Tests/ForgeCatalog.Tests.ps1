...
foreach($file in @('ForgeRecipes.cs','ForgeBalance.cs','ForgeAffinity.cs','ForgeTemplates.cs','ForgeRecipeCatalog.cs')){
...
public static class CatalogTests {
    ...
    public static string Run(){
        ...
        var snapshot=new Dictionary<string,int>();foreach(string key in new[]{"ACADEMY","LAKE","SHADOW","FLAMESWORD","FROST","DARKCLOUD","EMBER","GLACIER","MAGITECH","CURSE","COMPANION","SAVVY"})snapshot[key]=10;
